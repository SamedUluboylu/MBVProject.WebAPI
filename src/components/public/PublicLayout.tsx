          ...
          <div className="max-w-[1600px] mx-auto px-4 lg:px-6">
            <div className="flex items-center justify-between h-10 text-xs">
              <div className="flex items-center gap-4 text-slate-600">
                ...
                <a href="#" className="hover:text-orange-600 transition-colors hidden md:inline">Yardım</a>
                <a href="#" className="hover:text-orange-600 transition-colors hidden md:inline">Sipariş Takibi</a>
              </div>
              <div className="flex items-center gap-4 text-slate-600">
                {isAuthenticated && (
        ...
        <div className="max-w-[1600px] mx-auto px-4 lg:px-6">
          <div className="flex items-center gap-4 h-16 lg:h-20">
            <Link to="/" className="flex items-center gap-2 group flex-shrink-0">
              <div className="w-9 h-9 lg:w-11 lg:h-11 bg-gradient-to-br from-orange-600 to-orange-500 rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200 shadow-md">
            ...
            <form onSubmit={handleSearch} className="flex-1 max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 pl-10 pr-24 border-2 border-slate-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all text-sm"
                />
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 bg-orange-600 hover:bg-orange-700 text-white rounded-md font-semibold transition-colors text-xs lg:text-sm"
                >
                  Ara
                </button>
              </div>
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              >
                <svg className="w-6 h-6 lg:w-7 lg:h-7 text-slate-700 group-hover:text-orange-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                {totalItems > 0 && (
                  <span className="absolute -top-1 -right-1 bg-orange-600 text-white text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-md animate-scaleIn">
                    {totalItems}
                  </span>
                )}
              </Link>
              ...
              {isAuthenticated ? (
                ...
                <Link
                  to="/login"
                  className="hidden lg:flex items-center gap-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg transition-all shadow-sm hover:shadow-md text-sm"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200 bg-white animate-slideDown">
            <div className="px-4 py-4 space-y-2">
              <Link
                to="/"
                className="block px-4 py-3 text-slate-700 hover:bg-orange-50 hover:text-orange-600 rounded-lg font-medium transition-colors"
              ...
              {isAuthenticated ? (
                ...
                <Link
                  to="/login"
                  className="block px-4 py-3 bg-orange-600 text-white rounded-lg font-medium text-center transition-colors hover:bg-orange-700"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Giriş Yap
                </Link>
        ...
        <div className="max-w-[1600px] mx-auto px-4 lg:px-6 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
            <div className="lg:col-span-2">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-9 h-9 bg-slate-800 hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                <li><Link to="/" className="hover:text-orange-500 transition-colors">Ana Sayfa</Link></li>
                <li><Link to="/products" className="hover:text-orange-500 transition-colors">Ürünler</Link></li>
                <li><Link to="/cart" className="hover:text-orange-500 transition-colors">Sepet</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li><a href="#" className="hover:text-orange-500 transition-colors">Kariyer</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-slate-400 text-sm">
                ...
                <li><a href="#" className="hover:text-orange-500 transition-colors">Sipariş Takibi</a></li>
                <li><a href="#" className="hover:text-orange-500 transition-colors">İade & İptal</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-400 text-sm">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="hover:text-orange-500 transition-colors">Kullanım Şartları</a>
            </div>
          </div>
        </div>
      </footer>
